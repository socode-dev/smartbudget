    ...
    <main className="py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-4 bg-blue-50 p-4 rounded-lg shadow-md border border-blue-200">
          ...
          <button className="w-fit bg-blue-500 hover:bg-blue-600 transition text-sm text-white px-4 py-2 rounded-md cursor-pointer flex items-center gap-2">
            Set Limit
        ...
        <div className="flex flex-col gap-4 bg-indigo-50 p-4 rounded-lg shadow-md border border-indigo-200">
          ...
          <button className="w-fit bg-indigo-500 hover:bg-indigo-600 transition text-sm text-white px-4 py-2 rounded-md cursor-pointer flex items-center gap-2">
            Adjust Budget
            <FaArrowRight className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="flex flex-col gap-4 bg-green-50 p-4 rounded-lg shadow-md border border-green-200">
          ...
          <button className="w-fit bg-green-500 hover:bg-green-600 transition text-sm text-white px-4 py-2 rounded-md cursor-pointer flex items-center gap-2">
            Review Subscription
            <FaArrowRight className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="flex flex-col gap-4 p-4 bg-red-50 rounded-lg shadow-md border border-red-200">
          <p className="grow text-sm text-[rgb(var(--color-muted))]">
            You are on track to overspend in Groceries.
          </p>
          <button className="w-fit bg-red-500 hover:bg-red-600 transition text-sm text-white px-4 py-2 rounded-md cursor-pointer flex items-center gap-2">
            Enable Alerts
