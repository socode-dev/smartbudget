...
// LATE MONTH LOGIC
    const {explanation, suggestion} = getLateMonthInsight(outcome, spending, income, forecast, currency);
...
const getLateMonthInsight = (outcome, spending, income, forecast, currency) => {
    let explanation;
    let suggestion;
